...
<html lang="en">
  <head>
    ...
    <title>SCP Foundation API</title>
  </head>
  <body class="container body"> 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
          <a class="nav-link hoverable" href="starwars.php">StarWars</a>
          </li>
          <li class="nav-item active">
    ...
    <div class="bg-dark">
    <h1 class="text-center text-warning">Welcome to the SCP Foundation API</h1>
    </div>
...
<footer>
    <div class="jumbotron jumbotron-fluid bg-dark p-4 mt-5 mb-0">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 cizgi">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
            <div class="card bg-dark border-0">
              ...
              <p class="d-inline lead">Scp Foundation kool and wonderful things © 2020<br>            
              </p>
              </div>
            </div>
          </div>        
      ...
      <!-- Optional JavaScript -->
    <!-- jQuery first, then Popper.js, then Bootstrap JS need  -->  
